...
<div class="flex w-full h-72 mb-24  items-center justify-center ">
    ...
    <div class="flex flex-col w-96">
        ...
        <form action="r{{ route('signup.verify') }}" method="POST">

            @csrf
            <input type="number" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-3xl text-decoration-none text-center rounded-lg focus:ring-blue-500
             flex items-center focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                    dark:focus:ring-blue-500 dark:focus:border-blue-500 font-bold ">
