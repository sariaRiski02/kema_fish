    ...
    <div class="flex flex-col w-96">
        ...
        <form action="{{ route('signup.verify') }}" method="POST">
            ...
            <div class="flex justify-center ">
                ...
                <span class="text-md text-sm text-center font-medium text-gray-900 dark:text-white">
                    Tidak menerima kode verifikasi?
                    &nbsp;
                </span>
                <a href="{{ route('signup.resend' ) }}">
                    <p class="text-[#00417C] text-sm text-center font-medium underline dark:text-white">
                        kirim ulang
                    </p>
                </a>
            </div>
            ...
            <div class="flex justify-center text-sm text-center font-medium text-gray-900 dark:text-white">
                <span id="countDown">
...
<script>
    ...
    const x = setInterval(function() {
        ...
        // Hitung jarak antara sekarang dengan tanggal akhir
