...
<div class="p-4 sm:ml-64">
   ...
   <div class="mt-5 border relative overflow-x-auto shadow-lg sm:rounded-lg">
    ...
    <div class="p-5">
        ...
        <a href="{{ route('admin.create-product') }}" class="text-white bg-blue-800 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">+ produk</a>
    </div>
