                    ...
                    <div class="flex justify-between items-center ">
                        ...
                        <form class="max-w-xs">
                            <div class="relative flex items-center max-w-[11rem]">
                                ...
                                <p type="text" class="quantity-input bg-gray-50 border-x-0 border-gray-300 h-11 font-medium text-center text-gray-900 text-lg focus:ring-blue-500 
                                ...
                                dark:focus:border-blue-500"
                                    placeholder="" value="1" min="1" max="100" required >
